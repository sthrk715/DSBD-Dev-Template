...
export class MockDataService implements DashboardDataService {
  ...
  async getGifts(_params: GiftsQueryParams): Promise<GiftsData> {
    return {
      ...
      seasonComparison: [
        ...
        { season: 'fukubako', currentYear: 500000, prevYear: 400000, yoyGrowth: 25.0 },
      ],
  ...
  async getProducts(_params: DashboardQueryParams): Promise<ProductsData> {
    ...
    return {
      ...
      categoryMonthlySales: months.map((month) => ({
        month,
        'スープ': mockValue(3000000, 300000),
        'カレー': mockValue(2000000, 200000),
        'ギフトセット': mockValue(1800000, 250000),
        'サイドメニュー': mockValue(800000, 100000),
      })),
      categoryBreakdown: [
        { category: 'スープ', sales: 5800000, ratio: 0.38 },
        { category: 'カレー', sales: 3500000, ratio: 0.23 },
        { category: 'ギフトセット', sales: 3200000, ratio: 0.21 },
        { category: 'サイドメニュー', sales: 1500000, ratio: 0.10 },
        { category: 'その他', sales: 1200000, ratio: 0.08 },
      ],
      productRankingTable: [
        { rank: 1, name: '東京ボルシチ', category: 'スープ', sales: 1200000, quantity: 3200, avgPrice: 375 },
        { rank: 2, name: 'オマール海老のビスク', category: 'スープ', sales: 980000, quantity: 2800, avgPrice: 350 },
        { rank: 3, name: '6スープギフトセット', category: 'ギフトセット', sales: 850000, quantity: 420, avgPrice: 2024 },
        { rank: 4, name: 'とうもろこしの冷たいスープ', category: 'スープ', sales: 780000, quantity: 2400, avgPrice: 325 },
        { rank: 5, name: 'Curry for Gift', category: 'ギフトセット', sales: 720000, quantity: 360, avgPrice: 2000 },
        { rank: 6, name: 'ミネストローネ', category: 'スープ', sales: 650000, quantity: 2000, avgPrice: 325 },
        { rank: 7, name: 'カレーと麺のセット', category: 'カレー', sales: 580000, quantity: 1800, avgPrice: 322 },
        { rank: 8, name: '参鶏湯', category: 'スープ', sales: 520000, quantity: 1500, avgPrice: 347 },
        { rank: 9, name: '石窯パン', category: 'サイドメニュー', sales: 450000, quantity: 3000, avgPrice: 150 },
        { rank: 10, name: 'グリーンカレー', category: 'カレー', sales: 420000, quantity: 1400, avgPrice: 300 },
      ],
    }
  }
  ...
  async getEmail(_params: DashboardQueryParams): Promise<EmailData> {
    return {
      ...
      campaignPerformance: [
        { campaign: '冬の温活スープ特集', sent: 45000, opened: 14400, clicked: 2250, revenue: 680000, openRate: 32.0, clickRate: 5.0 },
        { campaign: 'バレンタインギフト', sent: 38000, opened: 12160, clicked: 1900, revenue: 520000, openRate: 32.0, clickRate: 5.0 },
